  ...
  PROCEDURE seg_lr IS
    CURSOR C_SegStat IS
      SELECT n.owner,n.tablespace_name,n.object_name,
             ...
             to_char(round(r.ratio * 100, 2),'999.99') ratio
       ...
       WHERE n.dataobj# = r.dataobj#
         ...
         AND n.dbid     = r.dbid;
    BEGIN
      print(TABLE_OPEN||'<TR><TH COLSPAN="5">Logical Reads per Segment</TH></TR>');
    ...
    CURSOR C_SegStat IS
      SELECT n.owner,n.tablespace_name,n.object_name,
       ...
       WHERE n.dataobj# = r.dataobj#
         ...
         AND n.dbid     = r.dbid;
    BEGIN
      print(TABLE_OPEN||'<TR><TH COLSPAN="5">Physical Reads per Segment</TH></TR>');
      L_LINE := ' <TR><TH CLASS="th_sub">TableSpace</TH><TH CLASS="th_sub">Object</TH>'||
