...
. $BINDIR/ospopen
#cat $SQLSET $SPFILE $BINDIR/ospout.pls $TWAITBODY $ALLWAITBODY $BGWAITBODY $WAITOBJ $TSQLBODY $DFSFILE $IOBODY $RECOBODY $BUFFBODY $PGABODY $ENQBODY $USSTATBODY $RULER $RBSBODY $LACTBODY $LMSBODY $CACHEBODY $SGABODY $PLUGINDIR/rlims.pls $IORABODY $BINDIR/footer.pls >osp.out
cat $SQLSET $SPFILE $BINDIR/ospout.pls $INSTACTBODY $TWAITBODY $ALLWAITBODY $BGWAITBODY $WAITOBJ $TSQLBODY $DFSFILE $IOBODY $RECOBODY $BUFFBODY $PGABODY $ENQBODY $USSTATBODY $RULER $RBSBODY $LACTBODY $LMSBODY $CACHEBODY $SGABODY $PLUGINDIR/rlims.pls $IORABODY $BINDIR/footer.pls | $ORACLE_HOME/bin/sqlplus -s /NOLOG
