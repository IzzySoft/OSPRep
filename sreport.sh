...
. $BINDIR/ospopen
#cat $SQLSET $SPFILE $BINDIR/ospout.pls $ALLWAITBODY $BGWAITBODY $BINDIR/ospout02.pls $TOPSQL $INSTACTBODY $DFSFILE $IOBODY $RECOBODY $BUFFBODY $PGABODY $ENQBODY $USSTATBODY $RULER $RBSBODY $LACTBODY $LMSBODY $CACHEBODY $SGABODY $PLUGINDIR/rlims.pls $IORABODY $BINDIR/footer.pls >osp.out
cat $SQLSET $SPFILE $BINDIR/ospout.pls $ALLWAITBODY $BGWAITBODY $BINDIR/ospout02.pls $TOPSQL $INSTACTBODY $DFSFILE $IOBODY $RECOBODY $BUFFBODY $PGABODY $ENQBODY $USSTATBODY $RULER $RBSBODY $LACTBODY $LMSBODY $CACHEBODY $SGABODY $PLUGINDIR/rlims.pls $IORABODY $BINDIR/footer.pls | $ORACLE_HOME/bin/sqlplus -s /NOLOG
